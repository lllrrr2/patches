...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Copy ID & Password", "Copy ID & Password"),
        ("ID and password copied", "ID and password copied"),
        ...
        ("verify_rustdesk_password_tip", "Verify LnDesk password"),
        ...
        ("preset_password_warning", "Double click the ID to copy it and send it to the IT staff"),
